...
- [Onboarding Seeding](concepts/onboarding-seeding.md) — where first-run seeding hooks in, why the starter permission set is curated rather than scraped, and why detection proposes instead of writing
